...
class AVInterface():
    ...
    def get_series_raw(self, marketId, function, interval):
    ...
    def get_series_close(self, marketId, function, interval):
        hist_data = []
        priceType = AVPriceType.CLOSE.value
        # Fetch price series
        series = self.get_series_raw(marketId, function, interval)
